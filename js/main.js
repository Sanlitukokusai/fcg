  ...
  (function initI18n() {
    const T = {
      jp: {
        ...
        'member.director.name': '呉 楽<small>Wu Le</small>',
        'member.director.role': '映画監督・プロデューサー・FCG Founder',
        'member.director.body': '<p class="is-jp">東京藝術大学大学院映像研究科映画専攻修了。現在は東京を拠点に、映画、広告、縦型ドラマ、国際共同制作など幅広い映像プロジェクトに携わっている。</p><p class="is-jp">監督作品は、釜山国際映画祭 New Currents 部門およびシルクロード国際映画祭をはじめとする国際映画祭に選出。</p><p class="is-jp">近年は、人工知能が映画制作と映像表現にもたらす変化に着目し、映画、AI、そして異文化間のストーリーテリングを横断する新たな映像言語の可能性を探求している。</p><p class="is-jp">FCGでは、映画的な表現力と先端技術、そして国際的なコラボレーションを融合した次世代の映像制作モデルの構築に取り組んでいる。</p>',
      ...
      en: {
        ...
        'member.count':         '<b>05</b>members · 2026',
        'member.director.head': '01 / Director',
        'member.director.name': 'Wu Le<small>Director · Producer · FCG Founder</small>',
        'member.director.role': 'Director, Producer &amp; Founder of FCG',
        'member.director.body': '<p>Based in Tokyo, Wu Le graduated from the Graduate School of Film and New Media at Tokyo University of the Arts. His work spans feature films, commercials, vertical dramas, and international co-productions across Japan and China.</p><p>His films have been selected for international film festivals, including the New Currents Competition at the Busan International Film Festival and the Silk Road International Film Festival.</p><p>In recent years, his practice has focused on the intersection of cinema, artificial intelligence, and cross-cultural storytelling, exploring new possibilities for visual expression and production in the AI era.</p><p>Through FCG, he is developing a next-generation filmmaking model that combines cinematic craftsmanship, emerging technologies, and international collaboration.</p>',
        'member.roster.head':   '02 / Roster',
        // ── news.html ──
        'news.crumb':           'FCG / News',
      ...
      cn: {
        ...
        'member.director.name': '吴乐<small>Wu Le</small>',
        'member.director.role': '导演 · 制片人 · FCG 创始人',
        'member.director.body': '<p>毕业于东京艺术大学大学院映像研究科电影专攻，现居东京。长期活跃于电影、广告、短剧及跨国影视制作领域，拥有中日两国创作与制作经验。</p><p>其作品曾入围釜山国际电影节 New Currents（新浪潮）主竞赛单元、丝绸之路国际电影节等国际电影节。</p><p>近年来持续关注人工智能对电影工业与视觉叙事的影响，致力于探索电影语言、AI 技术与跨文化表达之间的新可能。</p><p>作为 FCG 映像创始人之一，他正推动一种融合电影创作、人工智能与国际协作的新型影像生产模式，并持续开发面向未来的电影、短剧及品牌影像项目。</p>',
